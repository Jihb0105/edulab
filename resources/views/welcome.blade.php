...
<body class="d-flex flex-column min-vh-100">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                @elseif (auth()->user()->type == "lecturer")
                                    <a class="dropdown-item" href="{{ route('lecturers.settings.profile.edit') }}">Settings</a>
                                @else
    ...
    <main class="ms-0 me-0 mb-5">
        <img src="{{ url('images/onlineLearning.jpg') }}" class="w-100" style="height: 450px;">
        <div class="container mt-5">
            <h2><b>New Arrival</b> Courses</h2>
            <table style="margin-left:-2%">
                @forelse ($newArrivalCourses->chunk(4) as $newArrivalCoursesLimit)
                    <tr>
                        @foreach ($newArrivalCoursesLimit as $item)
                            <td class="p-4" width="150px">
                                <a href="{{ route('users.course', $item->id) }}" style="color: black; text-decoration: none">
                                    @if (empty($item->course_image))
                                        <img src="https://via.placeholder.com/150x150" class="mb-4 border" width="250" height="150">
                                    @else 
                                        <img src="{{ asset('storage/course_images/'.$item->course_image) }}" class="mb-4 border" width="250" height="150">
                                    @endif
                                    <p><b><span style="font-size: 100%">{{ $item->title }}</span></b></p>
                                    <span style="font-size: 100%">{{ $item->instructor->name }}</span>
                                </a>
                            </td>
                        @endforeach
                    </tr>
    ...
    <div class="container-fluid justify-content-center d-flex mt-auto" style="background-color: #464849;">
        <footer class="container row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-4 border-top d-flex justify-content-center">
            <div class="col me-5">
                <h5>Abouts EduLab</h5>
