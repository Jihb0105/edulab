...
<div class="container mt-5 px-5">
    <div class="card">
        <h2 class="card-header card-title" style="background-color:#009DA6"><b>Create Resource</b></h2>
        <div class="card-body">
            <form action="{{ route('lecturers.resource.store') }}" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf
