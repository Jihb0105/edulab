    ...
    <div class="row">
        <div class="col-md-3 border-right">
            ...
            <div class="text-center">
                ...
                <p class="fs-6"><a href="{{ route('users.getEnrolled') }}" style="color:#009DA6;text-decoration:none">Courses</a></p>
        ...
        <div class="col-md-9 border-right pb-5">
            <div class="p-3 pb-5">
                <div class="col-md-12">
                    <h4 class="d-flex justify-content-center"><b>My Learning</b></h4>
                    <p class="d-flex justify-content-center">See Your Enrolled Courses</p>
                </div>
