...
<body>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header card-title">
                        <h3 class="fw-bold mb-0 ms-4">Chapter 1 Quiz</h3>
                    </div>           
                    <div class="card-body">
                        <div class="row ms-3 me-3">
                            <form action="{{ route('users.submit', $chapter->id) }}" method="POST">
                                @csrf
                                <div class="col-md-12 mb-2">
                                    <h4>Q{{ $question->question_no }}: {{ $question->question }}</h4>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <input value="a" name="answer" type="radio"> (A) {{ $question->a }} <br>                          
                                    <input value="b" name="answer" type="radio"> (B) {{ $question->b }} <br>                          
                                    <input value="c" name="answer" type="radio"> (C) {{ $question->c }} <br>                          
                                    <input value="d" name="answer" type="radio"> (D) {{ $question->d }} <br>  
                                    <input value="{{ $question->answer }}" hidden name="dbans">                        
                                </div>
                                <div class="col-md-12 mt-5 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary" style="background-color: #009DA6; border-color:#009DA6">Next</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <footer class="container-fluid justify-content-center d-flex fixed-bottom" style="background-color: #464849;">
