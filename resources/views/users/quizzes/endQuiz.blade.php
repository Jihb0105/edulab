...
<body>
    ...
    <main class="py-4 d-flex align-items-center mb-5 mt-5">
        <div class="container d-flex justify-content-center mt-5" style="height:100%">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header card-title">
                        <h3 class="fw-bold mb-0 ms-4">Test Result</h3>
                    </div>           
                    <div class="card-body">
                        <div class="row ms-3 me-3">
                            <div class="col-md-12">
                                <label>Correct: <small>{{ Session::get('correctans') }}</small></label><br>
                                <label>Incorrect: <small>{{ Session::get('wrongans') }}</small></label><br>
                                <label>Total Result: <small>{{ Session::get('correctans') }}/{{ Session::get('correctans')+Session::get('wrongans') }}</small></label><br>
                                <div class="d-flex justify-content-end col-md-12">
                                    <a href="{{ route('users.chapter', $chapter->id) }}" class="btn btn-primary" style="background-color: #009DA6; border-color:#009DA6">End Quiz</a>
                                </div>
                            </div>
                        </div>
                    </div>
