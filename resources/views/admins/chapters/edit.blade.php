...
<div class="container mt-5">
    <div class="d-flex col-md-12" style="margin-left:-3.5%;">
        ...
        <form action="{{ route('admins.chapters.destroy', $chapter->id) }}" method="POST" class="ms-auto">
            @csrf
            @method('DELETE')
    ...
    <div class="d-flex justify-content-center">
        <div class="col-md-6 card p-4 mb-5">
            <form action="{{ route('admins.chapters.update', $chapter->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="form-group justify-content-center d-flex">
                    <a href="{{ route('admins.resource.index', $chapter->id) }}" class="btn btn-primary me-3" style="background: linear-gradient(90deg,#ffbf96,#fe7096); border: 0">Manage Resources</a>
                    <a href="{{ route('admins.quiz.index', $chapter->id) }}" class="btn btn-primary" style="background: linear-gradient(90deg,#90caf9,#047edf 99%); border: 0">Manage Quizzes</a>
                </div>
                ...
                <div class="form-group row mb-0">
                    <div class=" d-flex justify-content-center">
                        ...
                        <a href="{{ route('admins.chapters.backButton') }}" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
